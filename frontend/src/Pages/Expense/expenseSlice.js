...
export const getExpenseByType = createAsyncThunk(
    ...
    async (body, { rejectWithValue }) => {
        try {
            const { data } = await Api.post('/expense/getByType', body)
            return data
        } catch (error) {
            return rejectWithValue(error)
        }
...
export const getExpenseTypes = createAsyncThunk(
    'expensType/getExpense',
    async (body, { rejectWithValue }) => {
        try {
            const { data } = await Api.post('/expensType', body)
            return data
        } catch (error) {
            return rejectWithValue(error)
        }
...
export const createExpenseTypes = createAsyncThunk(
    'expensType/create',
    async (body, { rejectWithValue }) => {
        try {
            const { data } = await Api.post('/expensType/register', body)
            return data
        } catch (error) {
            return rejectWithValue(error)
        }
