    ...
    return (
        <nav className='float-right'>
            <ReactPaginate
                ...
                pageLinkClassName={
                    'w-[35px] h-[35px] border border-primary-800 rounded-lg text-sm flex justify-center items-center hover:bg-blue-600 hover:border-blue-600 hover:text-white-900 transition ease-in-out duration-100'
                }
                previousClassName={'mr-[15px]'}
                previousLinkClassName={
                    'w-[35px] h-[35px] border border-primary-800 rounded-lg text-sm text-primary-800 flex justify-center items-center hover:bg-blue-600 hover:border-blue-600 hover:text-white-900 transition ease-in-out duration-100'
                }
                ...
                activeLinkClassName={
                    'border border-primary-800 bg-blue-600 text-white-900'
                }
