...
import {
    changeCurrencyType,
} from '../../Pages/Currency/currencySlice'
...
const changeCurrency = () => {
    ...
    return (
        <section>
            <div className={'fixed zn-max z-[999] bg-[white]'}>
                <div
                    className={
                        navbarExpended
                            ? 'hamburg-menu bg-white-300'
                            : 'bg-white-300'
                    }
                >
                    {navbarExpended ? (
                ...
                <nav
                    className={` transition-all ease-in-out duration-200 min-h-screen bg-white-300 flex flex-col justify-between rounded-tr-[8px] rounded-br-[8px] shadow-[5px_0_25px_rgba(0,0,0,0.1),10px_0_50px_rgba(0,0,0,0.05)] ${
                        navbarExpended
                ...
                >
                    <div className={'navbar-header overflow-hidden'}>
                        ...
                        >
                            ...
                            <button
                                className={`toggle-avatar-menu transition ease duration-200 ${
                                    isAvatarMenuOpen
                                        ? 'text-primary-800'
                    ...
                    <div
                        className={`mb-[0px] navbar-footer transition-all ease-in-out duration-300 text-center flex flex-col justify-center gap-[10px] bg-white-400 border-t-[2px] border-t-black-100 ${
                            navbarExpended
                ...
                {isAvatarMenuOpen && (
                    <div className='avatar-config-menu absolute z-[90] w-max left-[7rem] top-[3.3rem] bg-primary-700 md:backdrop-blur-[8px] py-[10px] rounded-[8px]'>
