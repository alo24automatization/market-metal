...
function NavbarLink({
    ...
    const navLinkClasses = (isActive, path) => {
        ...
        } px-[0.9375rem] py-[0.625rem] gap-[0.9375rem] rounded-[1.875rem] transition ease-in-out duration-200 ${active ? 'text-white-900 bg-blue-600' : 'text-black-700 hover:bg-black-100'}`
    }
