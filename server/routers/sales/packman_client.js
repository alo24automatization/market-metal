...
router.post('/client/paymentDebt', auth, (req, res) => {
  require('./client').paymentDebt(req, res);
});
...
router.delete('/saleproducts/delete', auth, (req, res) => {
  require('./saleproduct').deleteSale(req, res);
});
